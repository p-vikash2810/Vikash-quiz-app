...
class QuizLeft extends React.Component {
  state = {
    question_1: 0,
    question_2: 0,
    correct_count: 0,
  ...
  generate_question() {
    ...
    let question_1 = Math.floor(Math.random() * (upperLimit - lowerLimit) ) + lowerLimit;
    let question_2 = Math.floor(Math.random() * (upperLimit - lowerLimit) ) + lowerLimit;
...
export default connect(mapStateToProps)(QuizLeft);
